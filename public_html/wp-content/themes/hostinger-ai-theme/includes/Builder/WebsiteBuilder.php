...
class WebsiteBuilder {
    ...
    public function __construct( RequestClient $request_client, ImageManager $image_manager, AffiliateBuilder $affiliate_builder, ElementorBuilder $elementor_builder, WooBuilder $woo_builder, HostingerReachBuilder $hostinger_reach_builder ) {
