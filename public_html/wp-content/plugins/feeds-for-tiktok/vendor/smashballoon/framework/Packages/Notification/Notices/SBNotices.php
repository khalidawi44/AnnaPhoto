 ...
 * @package Notices
 */
namespace TikTokFeeds\Vendor\Smashballoon\Framework\Packages\Notification\Notices;

use TikTokFeeds\Vendor\Smashballoon\Framework\Packages\Notification\Notices\AdminNotice;
use function TikTokFeeds\Vendor\Smashballoon\Framework\sb_map_notice_hooks;
use function TikTokFeeds\Vendor\Smashballoon\Framework\sb_get_plugin_type;
if (!defined('ABSPATH')) {
    exit;
}
/**
