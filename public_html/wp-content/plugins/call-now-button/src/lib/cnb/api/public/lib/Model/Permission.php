...
class Permission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PERMISSION_MANAGE_BUTTONS = 'MANAGE_BUTTONS';
    public const PERMISSION_MANAGE_DOMAIN = 'MANAGE_DOMAIN';
    public const PERMISSION_CHAT_AGENT = 'CHAT_AGENT';
    ...
    {
        return [
            self::PERMISSION_MANAGE_BUTTONS,
            self::PERMISSION_MANAGE_DOMAIN,
            self::PERMISSION_CHAT_AGENT,
        ];
    }
    ...
    */
     ...
     * Sets member
     *
     * @param \cnb\api\Model\WsMember $member member
     *
     * @return self
     */
