...
/**
 * PrivateNoteRequest Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class PrivateNoteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrivateNoteRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('related_message_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $related_message_id related_message_id
     *
     * @return self
     */
    public function setRelatedMessageId($related_message_id)
    {
        if (is_null($related_message_id)) {
            throw new \InvalidArgumentException('non-nullable related_message_id cannot be null');
        }
