...
class Verification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['verified_address'] === null) {
            $invalidProperties[] = "'verified_address' can't be null";
        }
        if ($this->container['verified_name'] === null) {
            $invalidProperties[] = "'verified_name' can't be null";
        }
     ...
     * Sets status
     *
     * @param string $status Verification status, one of {@code pending}, {@code verified}, {@code unverified}, or {@code unavailable}.
     *
     * @return self
     */
     ...
     *
     * @param string $verified_address verified_address
     *
     * @return self
     */
    public function setVerifiedAddress($verified_address)
    {
        if (is_null($verified_address)) {
            throw new \InvalidArgumentException('non-nullable verified_address cannot be null');
        }
