...
/**
 * MemberAddRequest Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class MemberAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberAddRequest';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email The email address used to invite this user
     *
     * @return self
     */
