...
/**
 * ProAccountCheckoutSessionResponse Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class ProAccountCheckoutSessionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProAccountCheckoutSessionResponse';
    ...
    */
     ...
     *
     * @param string $checkout_session_id checkout_session_id
     *
     * @return self
     */
