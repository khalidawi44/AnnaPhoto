 ...
 */
class Auth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('authorities', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorities'] === null) {
            $invalidProperties[] = "'authorities' can't be null";
        }
    ...
    public function setAuthorities($authorities)
    {
        if (is_null($authorities)) {
            throw new \InvalidArgumentException('non-nullable authorities cannot be null');
        }
