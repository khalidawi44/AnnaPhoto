...
/**
 * ChatAgentPersona Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class ChatAgentPersona implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatAgentPersona';
    ...
    public const AVAILABILITY_STATUS_ONLINE = 'ONLINE';
    public const AVAILABILITY_STATUS_OFFLINE = 'OFFLINE';
    public const TYPE_CHAT_CLIENT_PERSONA = 'ChatClientPersona';
    public const TYPE_CHAT_AGENT_PERSONA = 'ChatAgentPersona';
    public const TYPE_WORKSPACE_PERSONA = 'WorkspacePersona';
    public const TYPE_CHAT_WORKSPACE_DOMAIN_PERSONA = 'ChatWorkspaceDomainPersona';
    ...
    {
        return [
            self::AVAILABILITY_STATUS_ONLINE,
            self::AVAILABILITY_STATUS_OFFLINE,
        ];
    }
    ...
    {
        return [
            self::TYPE_CHAT_CLIENT_PERSONA,
            self::TYPE_CHAT_AGENT_PERSONA,
            self::TYPE_WORKSPACE_PERSONA,
            self::TYPE_CHAT_WORKSPACE_DOMAIN_PERSONA,
        ];
    }
    ...
    */
     ...
     *
     * @param string $availability_status availability_status
     *
     * @return self
     */
