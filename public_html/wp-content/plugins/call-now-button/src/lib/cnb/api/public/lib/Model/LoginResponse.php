...
class LoginResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'session' => '\cnb\api\Model\Session',
        'auth' => '\cnb\api\Model\Auth'
    ];
    ...
    */
     ...
     * Sets session
     *
     * @param \cnb\api\Model\Session $session session
     *
     * @return self
     */
     ...
     * Sets auth
     *
     * @param \cnb\api\Model\Auth $auth auth
     *
     * @return self
     */
