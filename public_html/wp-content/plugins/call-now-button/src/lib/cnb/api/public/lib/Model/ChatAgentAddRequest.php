...
/**
 * ChatAgentAddRequest Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class ChatAgentAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatAgentAddRequest';
    ...
    protected static $setters = [
        ...
        'domains' => 'setDomains',
        'default_assignee' => 'setDefaultAssignee',
    ...
    protected static $getters = [
        ...
        'domains' => 'getDomains',
        'default_assignee' => 'getDefaultAssignee',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('default_assignee', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['default_assignee'] === null) {
            $invalidProperties[] = "'default_assignee' can't be null";
        }
     ...
     * Sets avatar_url
     *
     * @param string|null $avatar_url An (optional) URL to an avatar for this user
     *
     * @return self
     */
    ...
    /**
     * Gets default_assignee
     *
     * @return string[]
     */
    public function getDefaultAssignee()
    {
        return $this->container['default_assignee'];
    }

    /**
     * Sets default_assignee
     *
     * @param string[] $default_assignee default_assignee
     *
     * @return self
     */
    public function setDefaultAssignee($default_assignee)
    {
        if (is_null($default_assignee)) {
            throw new \InvalidArgumentException('non-nullable default_assignee cannot be null');
        }
        $this->container['default_assignee'] = $default_assignee;
