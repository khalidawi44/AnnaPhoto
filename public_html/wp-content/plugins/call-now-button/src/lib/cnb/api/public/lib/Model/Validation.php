 ...
 *
 * @category Class
 * @description Validation message, shown to the User when a validation fails or requires attention
 * @package  cnb\api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Validation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Programmatic value to match client-side
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message Human-readable message to show to the User
     *
     * @return self
     */
