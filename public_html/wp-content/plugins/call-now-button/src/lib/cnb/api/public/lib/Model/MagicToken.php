 ...
 */
class MagicToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MagicToken';
    ...
    */
     ...
     * Sets used_date
     *
     * @param \DateTime|null $used_date used_date
     *
     * @return self
     */
    public function setUsedDate($used_date)
    {
        if (is_null($used_date)) {
            throw new \InvalidArgumentException('non-nullable used_date cannot be null');
        }
