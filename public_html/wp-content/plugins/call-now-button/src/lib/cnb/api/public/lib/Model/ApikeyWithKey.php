...
/**
 * ApikeyWithKey Class Doc Comment
 *
 * @category Class
 * @description This is the same object as Apikey, but with the API key embedded as the key property.
 * @package  cnb\api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ApikeyWithKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApikeyWithKey';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The API key that can be used to query the NowButtons API.
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string $user The user ID of the user who created this API.
     *
     * @return self
     */
