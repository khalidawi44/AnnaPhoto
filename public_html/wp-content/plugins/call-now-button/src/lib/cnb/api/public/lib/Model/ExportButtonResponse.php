...
/**
 * ExportButtonResponse Class Doc Comment
 *
 * @category Class
 * @package  cnb\api
 * @author   OpenAPI Generator team
 ...
 */
class ExportButtonResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportButtonResponse';
    ...
    */
     ...
     * Sets source_domain
     *
     * @param \cnb\api\Model\ImportDomain|null $source_domain Id of the Domain to copy settings from (optional)
     *
     * @return self
     */
